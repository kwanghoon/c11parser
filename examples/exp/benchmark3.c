// https://github.com/najibghadri/Tetris200lines/blob/master/tetris.c
//
// #include <stdio.h>
// #include <stdlib.h>
// #include <time.h>
...
int score = 0;
char GameOn = TRUE;
long timer = 400000; // decrease this to make it faster // suseconds_t
int decrease = 1000;
...
int hasToUpdate(){
	return ((long)(now.tv_sec*1000000 + now.tv_usec) -((long)before_now.tv_sec*1000000 + before_now.tv_usec)) > timer; // suseconds_t 
}
